...
*/
public class Pyro_LvL_2 extends KitHandler implements Shooter {

    public Pyro_LvL_2() {
        super(KitPvPKit.Type.PYRO, 2, new Obtainable(KitPvP.COINS, 65000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setHelmet(new ItemBuilder(Material.GOLD_HELMET, 1, 0, name() + "§bHelmet").addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 1).buildUnbreakable(true));
