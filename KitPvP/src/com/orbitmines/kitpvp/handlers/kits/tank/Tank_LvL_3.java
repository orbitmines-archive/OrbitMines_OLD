...
import com.orbitmines.kitpvp.handlers.passives.knockbackchance.KnockbackChance_LvL_3;
...
*/
public class Tank_LvL_3 extends KitHandler {

    public Tank_LvL_3() {
        super(KitPvPKit.Type.TANK, 3, new Obtainable(KitPvP.COINS, 80000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(0, add(new ItemBuilder(Material.STONE_SWORD, 1, 0, name() + "§bWeapon"), new KnockbackChance_LvL_3()).buildUnbreakable(true));

        kit.setHelmet(new ItemBuilder(Material.IRON_HELMET, 1, 0, name() + "§bHelmet").addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 1).buildUnbreakable(true));
        kit.setChestplate(new ItemBuilder(Material.IRON_CHESTPLATE, 1, 0, name() + "§bChestplate").addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 1).buildUnbreakable(true));
