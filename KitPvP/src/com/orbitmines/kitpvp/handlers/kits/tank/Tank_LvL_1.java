...
import com.orbitmines.kitpvp.handlers.passives.knockbackchance.KnockbackChance_LvL_1;
...
*/
public class Tank_LvL_1 extends KitHandler {

    public Tank_LvL_1() {
        super(KitPvPKit.Type.TANK, 1, new Obtainable(KitPvP.COINS, 15000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(0, add(new ItemBuilder(Material.WOOD_SWORD, 1, 0, name() + "§bWeapon"), new KnockbackChance_LvL_1()).buildUnbreakable(true));
        ...
        kit.setBoots(new ItemBuilder(Material.DIAMOND_BOOTS, 1, 0, name() + "§bBoots").buildUnbreakable(true));
