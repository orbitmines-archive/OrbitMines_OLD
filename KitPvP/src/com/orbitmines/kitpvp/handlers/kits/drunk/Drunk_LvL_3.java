...
import com.orbitmines.kitpvp.handlers.passives.bleed.Bleed_LvL_3;
...
*/
public class Drunk_LvL_3 extends KitHandler implements Shooter {

    private EntityNms nms;

    public Drunk_LvL_3() {
        super(KitPvPKit.Type.DRUNK, 3, new Obtainable(KitPvP.COINS, 87500));
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(0, add(new ItemBuilder(Material.GLASS_BOTTLE, 1, 0, name() + "§bWeapon").addEnchantment(Enchantment.DAMAGE_ALL, 7), new Bleed_LvL_3()).buildUnbreakable(true));
        ...
        kit.setHelmet(new ItemBuilder(Material.DIAMOND_HELMET, 1, 0, name() + "§bHelmet").buildUnbreakable(true));
