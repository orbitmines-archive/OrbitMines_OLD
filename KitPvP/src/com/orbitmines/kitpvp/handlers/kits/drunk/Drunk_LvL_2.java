...
import com.orbitmines.kitpvp.handlers.passives.bleed.Bleed_LvL_2;
...
*/
public class Drunk_LvL_2 extends KitHandler implements Shooter {

    private EntityNms nms;

    public Drunk_LvL_2() {
        super(KitPvPKit.Type.DRUNK, 2, new Obtainable(KitPvP.COINS, 52500));
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(0, add(new ItemBuilder(Material.GLASS_BOTTLE, 1, 0, name() + "§bWeapon").addEnchantment(Enchantment.DAMAGE_ALL, 7), new Bleed_LvL_2()).buildUnbreakable(true));
