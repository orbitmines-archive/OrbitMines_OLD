...
import com.orbitmines.kitpvp.handlers.passives.thor.Thor_LvL_2;
...
*/
public class Soldier_LvL_3 extends KitHandler {

    public Soldier_LvL_3() {
        super(KitPvPKit.Type.SOLDIER, 3, new Obtainable(KitPvP.COINS, 42500));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(0, add(new ItemBuilder(Material.STONE_SWORD, 1, 0, name() + "§bWeapon"), new Thor_LvL_2()).buildUnbreakable(true));
