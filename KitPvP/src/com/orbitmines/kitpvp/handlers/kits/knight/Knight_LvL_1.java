...
*/
public class Knight_LvL_1 extends KitHandler {

    public Knight_LvL_1() {
        super(KitPvPKit.Type.KNIGHT, 1, new Obtainable(VipRank.NONE));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(1, new PotionItemBuilder(PotionItemBuilder.Type.SPLASH, new PotionBuilder(PotionEffectType.HEAL, 0, 0), true, 1, name() + "§cHealing Potion").build());
