...
*/
public class Knight_LvL_2 extends KitHandler {

    public Knight_LvL_2() {
        super(KitPvPKit.Type.KNIGHT, 2, new Obtainable(KitPvP.COINS, 10000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(1, new PotionItemBuilder(PotionItemBuilder.Type.SPLASH, new PotionBuilder(PotionEffectType.HEAL, 0, 1), true, 1, name() + "§cHealing Potion").build());
