...
import com.orbitmines.kitpvp.handlers.passives.lightning.Lightning_LvL_1;
...
*/
public class Archer_LvL_2 extends KitHandler implements Shooter {

    public Archer_LvL_2() {
        super(KitPvPKit.Type.ARCHER, 2, new Obtainable(KitPvP.COINS, 25000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setItem(1, add(new ItemBuilder(Material.BOW, 1, 0, name() + "§bBow"), new Lightning_LvL_1()).buildUnbreakable(true));
        kit.setItem(2, new ItemBuilder(Material.ARROW, 46, 0, name() + "§bArrow").build());
    ...
    public OMRunnable.Time getReceiveTime() {
        return new OMRunnable.Time(OMRunnable.TimeUnit.SECOND, 12);
    }
