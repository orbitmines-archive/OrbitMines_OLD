...
*/
public class Bunny_LvL_2 extends KitHandler {

    public Bunny_LvL_2() {
        super(KitPvPKit.Type.BUNNY, 2, new Obtainable(KitPvP.COINS, 50000));
    }
    ...
    protected KitInteractive registerKit() {
        ...
        kit.setHelmet(new LeatherArmorBuilder(LeatherArmorBuilder.Type.HELMET, Bunny.LEATHER_COLOR, 1, name() + "§bHelmet").addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2).buildUnbreakable(true));
        ...
        kit.setBoots(new LeatherArmorBuilder(LeatherArmorBuilder.Type.BOOTS, Bunny.LEATHER_COLOR, 1, name() + "§bBoots").addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2).buildUnbreakable(true));
