...
public enum Hat implements Perk {
    ...
    GREEN_GLASS("Lime Stained Glass", Color.LIME, new ItemSet(Material.STAINED_GLASS, 1, 5), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ...
    BLACK_GLASS("Black Stained Glass", Color.GRAY, new ItemSet(Material.STAINED_GLASS, 1, 15), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ...
    RED_GLASS("Red Stained Glass", Color.MAROON, new ItemSet(Material.STAINED_GLASS, 1, 14), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ...
    MAGENTA_GLASS("Magenta Stained Glass", Color.FUCHSIA, new ItemSet(Material.STAINED_GLASS, 1, 2), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ...
    YELLOW_GLASS("Yellow Stained Glass", Color.YELLOW, new ItemSet(Material.STAINED_GLASS, 1, 4), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    MYCELIUM("Mycelium", Color.SILVER, new ItemSet(Material.MYCEL, 1, 4), new Obtainable(OrbitMinesApi.VIP_POINTS, 75)),
    LEAVES("Leaves", Color.GREEN, new ItemSet(Material.LEAVES), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ORANGE_GLASS("Orange Stained Glass", Color.ORANGE, new ItemSet(Material.STAINED_GLASS, 1, 1), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    DIORITE("Polished Diorite", Color.WHITE, new ItemSet(Material.STONE, 1, 4), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    IRON_BLOCK("Iron Block", Color.SILVER, new ItemSet(Material.IRON_BLOCK), new Obtainable(VipRank.IRON)),
    DARK_PRISMARINE("Dark Prismarine", Color.TEAL, new ItemSet(Material.PRISMARINE, 1, 2), new Obtainable(OrbitMinesApi.VIP_POINTS, 150)),
    SLIME_BLOCK("Slime Block", Color.LIME, new ItemSet(Material.SLIME_BLOCK), new Obtainable(OrbitMinesApi.VIP_POINTS, 200)),
    GRANITE("Polished Granite", Color.RED, new ItemSet(Material.STONE, 1, 2), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    ...
    PRISMARINE_BRICKS("Prismarine Bricks", Color.BLUE, new ItemSet(Material.PRISMARINE, 1, 1), new Obtainable(OrbitMinesApi.VIP_POINTS, 150)),
    ...
    WET_SPONGE("Wet Sponge", Color.YELLOW, new ItemSet(Material.SPONGE, 1, 1), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ANDESITE("Polished Andesite", Color.SILVER, new ItemSet(Material.STONE, 1, 6), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    DIAMOND_BLOCK("Diamond Block", Color.AQUA, new ItemSet(Material.DIAMOND_BLOCK), new Obtainable(VipRank.DIAMOND)),
    BLUE_GLASS("Blue Stained Glass", Color.NAVY, new ItemSet(Material.STAINED_GLASS, 1, 11), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    ACACIA_WOOD("Acacia Wood", Color.ORANGE, new ItemSet(Material.WOOD, 1, 4), new Obtainable(OrbitMinesApi.VIP_POINTS, 75)),
    RED_WOOL("Red Wool", Color.RED, new ItemSet(Material.WOOL, 1, 14), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    BROWN_GLASS("Brown Stained Glass", Color.WHITE, new ItemSet(Material.STAINED_GLASS, 1, 12), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
    SOUL_SAND("Soul Sand", Color.YELLOW, new ItemSet(Material.SOUL_SAND), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    CHISELLED_STONE_BRICKS("Chiselled Stone Bricks", Color.SILVER, new ItemSet(Material.SMOOTH_BRICK, 1, 3), new Obtainable(OrbitMinesApi.VIP_POINTS, 100)),
    ...
    CYAN_GLASS("Cyan Stained Glass", Color.TEAL, new ItemSet(Material.STAINED_GLASS, 1, 9), new Obtainable(OrbitMinesApi.VIP_POINTS, 125)),
