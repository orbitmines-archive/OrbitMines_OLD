...
public enum Trail implements Perk {
    ...
    MAGIC("Magic", Particle.CRIT_MAGIC, Color.TEAL, new ItemSet(Material.INK_SACK, 1, 6), new Obtainable(VipRank.IRON)),
    ...
    WITCH("Witch", Particle.SPELL_WITCH, Color.PURPLE, new ItemSet(Material.INK_SACK, 1, 5), new Obtainable(OrbitMinesApi.VIP_POINTS, 350)),
