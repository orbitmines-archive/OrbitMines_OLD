 ...
 */
public class EntityNms_1_8_R1 implements EntityNms {
    ...
    public void setSpeed(Entity entity, double d) {
        AttributeInstance currentSpeed = ((CraftLivingEntity) entity).getHandle().getAttributeInstance(GenericAttributes.d);
        currentSpeed.setValue(d);
    }

    @Override
    public double getSpeed(Entity entity) {
        return ((CraftLivingEntity) entity).getHandle().getAttributeInstance(GenericAttributes.d).b();
    }
    ...
    public void disguiseAsBlock(Player player, int Id, Player... players) {
        ...
        disguise.d(((CraftPlayer) player).getHandle().getId());
