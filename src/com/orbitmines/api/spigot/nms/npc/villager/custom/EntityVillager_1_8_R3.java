 ...
 */
public class EntityVillager_1_8_R3 extends EntityVillager {

    private boolean moving;

    public EntityVillager_1_8_R3(World world) {
        super(world);
    }

    public EntityVillager_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
