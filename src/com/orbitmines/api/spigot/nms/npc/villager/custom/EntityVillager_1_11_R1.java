 ...
 */
public class EntityVillager_1_11_R1 extends EntityVillager {

    private boolean moving;

    public EntityVillager_1_11_R1(World world) {
        super(world);
    }

    public EntityVillager_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
