 ...
 */
public class EntityVillager_1_9_R2 extends EntityVillager {

    private boolean moving;

    public EntityVillager_1_9_R2(World world) {
        super(world);
    }

    public EntityVillager_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
