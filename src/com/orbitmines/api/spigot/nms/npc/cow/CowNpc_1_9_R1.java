...
import com.orbitmines.api.spigot.nms.npc.cow.custom.EntityCow_1_9_R1;
 ...
 */
public class CowNpc_1_9_R1 implements CowNpc {

    public CowNpc_1_9_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityCow_1_9_R1.class, "CustomCow", Id);
    }
