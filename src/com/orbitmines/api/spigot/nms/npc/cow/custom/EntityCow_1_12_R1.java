 ...
 */
public class EntityCow_1_12_R1 extends EntityCow {

    private boolean moving;

    public EntityCow_1_12_R1(World world) {
        super(world);
    }

    public EntityCow_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
