 ...
 */
public class EntitySlime_1_9_R2 extends EntitySlime {

    private boolean moving;

    public EntitySlime_1_9_R2(World world) {
        super(world);
    }

    public EntitySlime_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
