 ...
 */
public class EntitySlime_1_8_R3 extends EntitySlime {

    private boolean moving;

    public EntitySlime_1_8_R3(World world) {
        super(world);
    }

    public EntitySlime_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
