 ...
 */
public class EntitySlime_1_12_R1 extends EntitySlime {

    private boolean moving;

    public EntitySlime_1_12_R1(World world) {
        super(world);
    }

    public EntitySlime_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
