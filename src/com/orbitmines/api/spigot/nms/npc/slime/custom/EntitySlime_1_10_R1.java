package com.orbitmines.api.spigot.nms.npc.slime.custom;
 ...
 */
public class EntitySlime_1_10_R1 extends EntitySlime {

    private boolean moving;

    public EntitySlime_1_10_R1(World world) {
        super(world);
    }

    public EntitySlime_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
