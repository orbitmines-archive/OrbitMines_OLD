 ...
 */
public class EntityWolf_1_8_R3 extends EntityWolf {

    private boolean moving;

    public EntityWolf_1_8_R3(World world) {
        super(world);
    }

    public EntityWolf_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
