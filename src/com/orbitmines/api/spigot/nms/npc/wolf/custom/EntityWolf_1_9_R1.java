 ...
 */
public class EntityWolf_1_9_R1 extends EntityWolf {

    private boolean moving;

    public EntityWolf_1_9_R1(World world) {
        super(world);
    }

    public EntityWolf_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
