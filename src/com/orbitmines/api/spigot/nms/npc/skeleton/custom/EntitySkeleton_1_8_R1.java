package com.orbitmines.api.spigot.nms.npc.skeleton.custom;
 ...
 */
public class EntitySkeleton_1_8_R1 extends EntitySkeleton {

    private boolean moving;

    public EntitySkeleton_1_8_R1(World world) {
        super(world);
    }

    public EntitySkeleton_1_8_R1(World world, boolean moving, boolean noAttack) {
        super(world);
