...
import com.orbitmines.api.spigot.nms.npc.skeleton.custom.EntitySkeleton_1_11_R1;
...
public class SkeletonNpc_1_11_R1 implements SkeletonNpc {
    ...
    public SkeletonNpc_1_11_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntitySkeleton_1_11_R1.class, "CustomSkeleton", Id);
    }
