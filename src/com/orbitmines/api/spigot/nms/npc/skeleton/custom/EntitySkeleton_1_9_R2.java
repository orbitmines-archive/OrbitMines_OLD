 ...
 */
public class EntitySkeleton_1_9_R2 extends EntitySkeleton {

    private boolean moving;

    public EntitySkeleton_1_9_R2(World world) {
        super(world);
    }

    public EntitySkeleton_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
