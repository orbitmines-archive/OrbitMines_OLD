 ...
 */
public class EntitySkeleton_1_8_R3 extends EntitySkeleton {

    private boolean moving;

    public EntitySkeleton_1_8_R3(World world) {
        super(world);
    }

    public EntitySkeleton_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
