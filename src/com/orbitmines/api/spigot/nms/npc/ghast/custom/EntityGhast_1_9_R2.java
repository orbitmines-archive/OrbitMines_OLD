 ...
 */
public class EntityGhast_1_9_R2 extends EntityGhast {

    private boolean moving;

    public EntityGhast_1_9_R2(World world) {
        super(world);
    }

    public EntityGhast_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
