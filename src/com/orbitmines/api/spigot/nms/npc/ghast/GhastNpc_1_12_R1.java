...
import com.orbitmines.api.spigot.nms.npc.ghast.custom.EntityGhast_1_12_R1;
...
public class GhastNpc_1_12_R1 implements GhastNpc {
    ...
    public GhastNpc_1_12_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityGhast_1_12_R1.class, "CustomGhast", Id);
    }
