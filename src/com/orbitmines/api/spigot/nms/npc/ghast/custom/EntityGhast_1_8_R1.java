 ...
 */
public class EntityGhast_1_8_R1 extends EntityGhast {

    private boolean moving;

    public EntityGhast_1_8_R1(World world) {
        super(world);
    }

    public EntityGhast_1_8_R1(World world, boolean moving, boolean noAttack) {
        super(world);
