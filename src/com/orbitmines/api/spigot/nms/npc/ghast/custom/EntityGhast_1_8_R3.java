 ...
 */
public class EntityGhast_1_8_R3 extends EntityGhast {

    private boolean moving;

    public EntityGhast_1_8_R3(World world) {
        super(world);
    }

    public EntityGhast_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
