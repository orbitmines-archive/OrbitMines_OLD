package com.orbitmines.api.spigot.nms.npc.witherskeleton.custom;
 ...
 */
public class EntityWitherSkeleton_1_12_R1 extends EntitySkeletonWither {

    private boolean moving;

    public EntityWitherSkeleton_1_12_R1(World world) {
        super(world);
    }

    public EntityWitherSkeleton_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
