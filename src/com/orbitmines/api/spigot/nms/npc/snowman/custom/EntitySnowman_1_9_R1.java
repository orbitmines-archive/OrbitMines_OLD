 ...
 */
public class EntitySnowman_1_9_R1 extends EntitySnowman {

    private boolean moving;

    public EntitySnowman_1_9_R1(World world) {
        super(world);
    }

    public EntitySnowman_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
