 ...
 */
public class EntitySnowman_1_8_R2 extends EntitySnowman {

    private boolean moving;

    public EntitySnowman_1_8_R2(World world) {
        super(world);
    }

    public EntitySnowman_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
