 ...
 */
public class EntityPig_1_10_R1 extends EntityPig {

    private boolean moving;

    public EntityPig_1_10_R1(World world) {
        super(world);
    }

    public EntityPig_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
