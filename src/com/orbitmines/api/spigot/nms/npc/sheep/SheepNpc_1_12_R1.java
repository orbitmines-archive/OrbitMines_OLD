...
import com.orbitmines.api.spigot.nms.npc.sheep.custom.EntitySheep_1_12_R1;
...
public class SheepNpc_1_12_R1 implements SheepNpc {
    ...
    public SheepNpc_1_12_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntitySheep_1_12_R1.class, "CustomSheep", Id);
    }
