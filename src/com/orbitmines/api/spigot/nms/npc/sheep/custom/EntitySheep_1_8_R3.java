 ...
 */
public class EntitySheep_1_8_R3 extends EntitySheep {

    private boolean moving;

    public EntitySheep_1_8_R3(World world) {
        super(world);
    }

    public EntitySheep_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
