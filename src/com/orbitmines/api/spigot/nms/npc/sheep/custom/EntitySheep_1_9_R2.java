 ...
 */
public class EntitySheep_1_9_R2 extends EntitySheep {

    private boolean moving;

    public EntitySheep_1_9_R2(World world) {
        super(world);
    }

    public EntitySheep_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
