 ...
 */
public class EntitySheep_1_9_R1 extends EntitySheep {

    private boolean moving;

    public EntitySheep_1_9_R1(World world) {
        super(world);
    }

    public EntitySheep_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
