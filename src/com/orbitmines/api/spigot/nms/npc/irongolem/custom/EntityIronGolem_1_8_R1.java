 ...
 */
public class EntityIronGolem_1_8_R1 extends EntityIronGolem {

    private boolean moving;

    public EntityIronGolem_1_8_R1(World world) {
        super(world);
    }

    public EntityIronGolem_1_8_R1(World world, boolean moving, boolean noAttack) {
        super(world);
