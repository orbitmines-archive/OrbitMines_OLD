 ...
 */
public class EntityIronGolem_1_8_R3 extends EntityIronGolem {

    private boolean moving;

    public EntityIronGolem_1_8_R3(World world) {
        super(world);
    }

    public EntityIronGolem_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
