 ...
 */
public class EntityHorse_1_8_R2 extends EntityHorse {

    private boolean moving;

    public EntityHorse_1_8_R2(World world) {
        super(world);
    }

    public EntityHorse_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
