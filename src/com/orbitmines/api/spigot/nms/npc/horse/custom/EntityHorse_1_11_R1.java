 ...
 */
public class EntityHorse_1_11_R1 extends EntityHorse {

    private boolean moving;

    public EntityHorse_1_11_R1(World world) {
        super(world);
    }

    public EntityHorse_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
