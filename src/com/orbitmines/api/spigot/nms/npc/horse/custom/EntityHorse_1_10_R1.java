package com.orbitmines.api.spigot.nms.npc.horse.custom;
 ...
 */
public class EntityHorse_1_10_R1 extends EntityHorse {

    private boolean moving;

    public EntityHorse_1_10_R1(World world) {
        super(world);
    }

    public EntityHorse_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
