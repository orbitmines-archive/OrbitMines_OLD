...
import com.orbitmines.api.spigot.nms.npc.horse.custom.EntityHorse_1_9_R1;
...
public class HorseNpc_1_9_R1 implements HorseNpc {
    ...
    public HorseNpc_1_9_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityHorse_1_9_R1.class, "CustomHorse", Id);
    }
