...
import com.orbitmines.api.spigot.nms.npc.rabbit.custom.EntityRabbit_1_12_R1;
...
public class RabbitNpc_1_12_R1 implements RabbitNpc {
    ...
    public RabbitNpc_1_12_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityRabbit_1_12_R1.class, "CustomRabbit", Id);
    }
