 ...
 */
public class EntityRabbit_1_12_R1 extends EntityRabbit {

    private boolean moving;

    public EntityRabbit_1_12_R1(World world) {
        super(world);
    }

    public EntityRabbit_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
