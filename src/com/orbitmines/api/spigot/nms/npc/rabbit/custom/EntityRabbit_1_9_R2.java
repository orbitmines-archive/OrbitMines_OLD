 ...
 */
public class EntityRabbit_1_9_R2 extends EntityRabbit {

    private boolean moving;

    public EntityRabbit_1_9_R2(World world) {
        super(world);
    }

    public EntityRabbit_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
