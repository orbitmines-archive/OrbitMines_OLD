 ...
 */
public class EntitySquid_1_11_R1 extends EntitySquid {

    private boolean moving;

    public EntitySquid_1_11_R1(World world) {
        super(world);
    }

    public EntitySquid_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
