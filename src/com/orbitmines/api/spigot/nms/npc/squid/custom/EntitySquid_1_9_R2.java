 ...
 */
public class EntitySquid_1_9_R2 extends EntitySquid {

    private boolean moving;

    public EntitySquid_1_9_R2(World world) {
        super(world);
    }

    public EntitySquid_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
