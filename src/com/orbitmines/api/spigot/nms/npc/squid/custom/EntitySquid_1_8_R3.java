 ...
 */
public class EntitySquid_1_8_R3 extends EntitySquid {

    private boolean moving;

    public EntitySquid_1_8_R3(World world) {
        super(world);
    }

    public EntitySquid_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
