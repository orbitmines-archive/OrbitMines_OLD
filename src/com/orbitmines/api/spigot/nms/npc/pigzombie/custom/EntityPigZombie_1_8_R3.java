 ...
 */
public class EntityPigZombie_1_8_R3 extends EntityPigZombie {

    private boolean moving;

    public EntityPigZombie_1_8_R3(World world) {
        super(world);
    }

    public EntityPigZombie_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
