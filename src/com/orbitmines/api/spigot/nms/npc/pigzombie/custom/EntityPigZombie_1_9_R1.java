 ...
 */
public class EntityPigZombie_1_9_R1 extends EntityPigZombie {

    private boolean moving;

    public EntityPigZombie_1_9_R1(World world) {
        super(world);
    }

    public EntityPigZombie_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
