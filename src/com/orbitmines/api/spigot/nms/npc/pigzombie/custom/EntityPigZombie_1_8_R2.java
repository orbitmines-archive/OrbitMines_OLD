 ...
 */
public class EntityPigZombie_1_8_R2 extends EntityPigZombie {

    private boolean moving;

    public EntityPigZombie_1_8_R2(World world) {
        super(world);
    }

    public EntityPigZombie_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
