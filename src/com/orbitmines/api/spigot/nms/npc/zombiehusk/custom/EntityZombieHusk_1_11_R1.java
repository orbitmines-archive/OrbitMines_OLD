package com.orbitmines.api.spigot.nms.npc.zombiehusk.custom;
 ...
 */
public class EntityZombieHusk_1_11_R1 extends EntityZombieHusk {

    private boolean moving;

    public EntityZombieHusk_1_11_R1(World world) {
        super(world);
    }

    public EntityZombieHusk_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
