 ...
 */
public class EntityZombieHusk_1_12_R1 extends EntityZombieHusk {

    private boolean moving;

    public EntityZombieHusk_1_12_R1(World world) {
        super(world);
    }

    public EntityZombieHusk_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
