 ...
 */
public class EntityLlama_1_11_R1 extends EntityLlama {

    private boolean moving;

    public EntityLlama_1_11_R1(World world) {
        super(world);
    }

    public EntityLlama_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
