package com.orbitmines.api.spigot.nms.npc.llama.custom;
 ...
 */
public class EntityLlama_1_12_R1 extends EntityLlama {

    private boolean moving;

    public EntityLlama_1_12_R1(World world) {
        super(world);
    }

    public EntityLlama_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
