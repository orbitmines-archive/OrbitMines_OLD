 ...
 */
public class EntitySkeletonHorse_1_11_R1 extends EntityHorseSkeleton {

    private boolean moving;

    public EntitySkeletonHorse_1_11_R1(World world) {
        super(world);
    }

    public EntitySkeletonHorse_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
