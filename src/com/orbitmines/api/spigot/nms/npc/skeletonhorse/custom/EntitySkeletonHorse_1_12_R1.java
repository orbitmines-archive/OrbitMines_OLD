package com.orbitmines.api.spigot.nms.npc.skeletonhorse.custom;
 ...
 */
public class EntitySkeletonHorse_1_12_R1 extends EntityHorseSkeleton {

    private boolean moving;

    public EntitySkeletonHorse_1_12_R1(World world) {
        super(world);
    }

    public EntitySkeletonHorse_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
