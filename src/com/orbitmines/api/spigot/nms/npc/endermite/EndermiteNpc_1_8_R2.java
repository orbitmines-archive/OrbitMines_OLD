...
import com.orbitmines.api.spigot.nms.npc.endermite.custom.EntityEndermite_1_8_R2;
...
public class EndermiteNpc_1_8_R2 implements EndermiteNpc {
    ...
    public EndermiteNpc_1_8_R2() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityEndermite_1_8_R2.class, "CustomEndermite", Id);
    }
