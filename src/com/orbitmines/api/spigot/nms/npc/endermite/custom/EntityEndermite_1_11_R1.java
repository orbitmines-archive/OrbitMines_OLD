 ...
 */
public class EntityEndermite_1_11_R1 extends EntityEndermite {

    private boolean moving;

    public EntityEndermite_1_11_R1(World world) {
        super(world);
    }

    public EntityEndermite_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
