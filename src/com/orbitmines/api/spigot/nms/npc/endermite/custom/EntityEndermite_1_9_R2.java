 ...
 */
public class EntityEndermite_1_9_R2 extends EntityEndermite {

    private boolean moving;

    public EntityEndermite_1_9_R2(World world) {
        super(world);
    }

    public EntityEndermite_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
