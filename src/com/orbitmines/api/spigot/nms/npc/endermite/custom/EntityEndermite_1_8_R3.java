 ...
 */
public class EntityEndermite_1_8_R3 extends EntityEndermite {

    private boolean moving;

    public EntityEndermite_1_8_R3(World world) {
        super(world);
    }

    public EntityEndermite_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
