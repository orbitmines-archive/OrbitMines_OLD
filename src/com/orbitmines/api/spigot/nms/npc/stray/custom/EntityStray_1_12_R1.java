 ...
 */
public class EntityStray_1_12_R1 extends EntitySkeletonStray {

    private boolean moving;

    public EntityStray_1_12_R1(World world) {
        super(world);
    }

    public EntityStray_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
