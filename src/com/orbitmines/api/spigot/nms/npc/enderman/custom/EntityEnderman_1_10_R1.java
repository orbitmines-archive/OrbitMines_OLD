package com.orbitmines.api.spigot.nms.npc.enderman.custom;
 ...
 */
public class EntityEnderman_1_10_R1 extends EntityEnderman {

    private boolean moving;

    public EntityEnderman_1_10_R1(World world) {
        super(world);
    }

    public EntityEnderman_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
