 ...
 */
public class EntityEnderman_1_8_R2 extends EntityEnderman {

    private boolean moving;

    public EntityEnderman_1_8_R2(World world) {
        super(world);
    }

    public EntityEnderman_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
