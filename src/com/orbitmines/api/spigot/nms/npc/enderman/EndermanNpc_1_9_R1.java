...
import com.orbitmines.api.spigot.nms.npc.enderman.custom.EntityEnderman_1_9_R1;
...
public class EndermanNpc_1_9_R1 implements EndermanNpc {
    ...
    public EndermanNpc_1_9_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityEnderman_1_9_R1.class, "CustomEnderman", Id);
    }
