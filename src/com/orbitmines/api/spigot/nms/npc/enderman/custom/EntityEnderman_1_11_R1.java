 ...
 */
public class EntityEnderman_1_11_R1 extends EntityEnderman {

    private boolean moving;

    public EntityEnderman_1_11_R1(World world) {
        super(world);
    }

    public EntityEnderman_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
