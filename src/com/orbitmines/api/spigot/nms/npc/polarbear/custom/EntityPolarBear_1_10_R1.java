package com.orbitmines.api.spigot.nms.npc.polarbear.custom;
 ...
 */
public class EntityPolarBear_1_10_R1 extends EntityPolarBear {

    private boolean moving;

    public EntityPolarBear_1_10_R1(World world) {
        super(world);
    }

    public EntityPolarBear_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
        ...
        goalB.clear();
        LinkedHashSet goalC = (LinkedHashSet) NpcNms_1_10_R1.getPrivateField("c", PathfinderGoalSelector.class, this.goalSelector);
        goalC.clear();
        LinkedHashSet targetC = (LinkedHashSet) NpcNms_1_10_R1.getPrivateField("c", PathfinderGoalSelector.class, this.targetSelector);
        targetC.clear();
    }
