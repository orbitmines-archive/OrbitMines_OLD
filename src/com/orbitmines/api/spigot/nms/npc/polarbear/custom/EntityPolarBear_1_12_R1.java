 ...
 */
public class EntityPolarBear_1_12_R1 extends EntityPolarBear {

    private boolean moving;

    public EntityPolarBear_1_12_R1(World world) {
        super(world);
    }

    public EntityPolarBear_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
