...
import com.orbitmines.api.spigot.nms.npc.zombiehorse.custom.EntityZombieHorse_1_11_R1;
 ...
 */
public class ZombieHorseNpc_1_11_R1 implements ZombieHorseNpc {

    public ZombieHorseNpc_1_11_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityZombieHorse_1_11_R1.class, "CustomZombieHorse", Id);
    }
