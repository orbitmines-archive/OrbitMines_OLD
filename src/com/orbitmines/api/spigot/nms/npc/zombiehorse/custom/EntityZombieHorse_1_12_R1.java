package com.orbitmines.api.spigot.nms.npc.zombiehorse.custom;
 ...
 */
public class EntityZombieHorse_1_12_R1 extends EntityHorseZombie {

    private boolean moving;

    public EntityZombieHorse_1_12_R1(World world) {
        super(world);
    }

    public EntityZombieHorse_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
