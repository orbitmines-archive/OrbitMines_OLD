 ...
 */
public class EntityZombieHorse_1_11_R1 extends EntityHorseZombie {

    private boolean moving;

    public EntityZombieHorse_1_11_R1(World world) {
        super(world);
    }

    public EntityZombieHorse_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
