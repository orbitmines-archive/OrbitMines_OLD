 ...
 */
public class EntityGuardian_1_12_R1 extends EntityGuardian {

    private boolean moving;

    public EntityGuardian_1_12_R1(World world) {
        super(world);
    }

    public EntityGuardian_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
