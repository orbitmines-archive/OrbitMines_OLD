 ...
 */
public class EntityGuardian_1_9_R2 extends EntityGuardian {

    private boolean moving;

    public EntityGuardian_1_9_R2(World world) {
        super(world);
    }

    public EntityGuardian_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
