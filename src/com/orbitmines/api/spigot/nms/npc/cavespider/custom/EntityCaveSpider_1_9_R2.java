 ...
 */
public class EntityCaveSpider_1_9_R2 extends EntityCaveSpider {

    private boolean moving;

    public EntityCaveSpider_1_9_R2(World world) {
        super(world);
    }

    public EntityCaveSpider_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
