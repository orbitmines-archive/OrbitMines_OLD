package com.orbitmines.api.spigot.nms.npc.cavespider.custom;
 ...
 */
public class EntityCaveSpider_1_8_R1 extends EntityCaveSpider {

    private boolean moving;

    public EntityCaveSpider_1_8_R1(World world) {
        super(world);
    }

    public EntityCaveSpider_1_8_R1(World world, boolean moving, boolean noAttack) {
        super(world);
        ...
        goalB.clear();
        List goalC = (List) NpcNms_1_8_R1.getPrivateField("c", PathfinderGoalSelector.class, this.goalSelector);
        goalC.clear();
        List targetC = (List) NpcNms_1_8_R1.getPrivateField("c", PathfinderGoalSelector.class, this.targetSelector);
        targetC.clear();
    }
