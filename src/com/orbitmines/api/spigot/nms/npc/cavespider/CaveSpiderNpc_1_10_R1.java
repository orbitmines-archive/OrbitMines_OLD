...
import com.orbitmines.api.spigot.nms.npc.cavespider.custom.EntityCaveSpider_1_10_R1;
 ...
 */
public class CaveSpiderNpc_1_10_R1 implements CaveSpiderNpc {

    public CaveSpiderNpc_1_10_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityCaveSpider_1_10_R1.class, "CustomCaveSpider", Id);
    }
