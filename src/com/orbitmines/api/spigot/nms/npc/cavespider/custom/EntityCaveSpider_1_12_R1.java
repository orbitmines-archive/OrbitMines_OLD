 ...
 */
public class EntityCaveSpider_1_12_R1 extends EntityCaveSpider {

    private boolean moving;

    public EntityCaveSpider_1_12_R1(World world) {
        super(world);
    }

    public EntityCaveSpider_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
