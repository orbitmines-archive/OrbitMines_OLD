 ...
 */
public class EntityMagmaCube_1_8_R3 extends EntityMagmaCube {

    private boolean moving;

    public EntityMagmaCube_1_8_R3(World world) {
        super(world);
    }

    public EntityMagmaCube_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
