 ...
 */
public class EntityMagmaCube_1_11_R1 extends EntityMagmaCube {

    private boolean moving;

    public EntityMagmaCube_1_11_R1(World world) {
        super(world);
    }

    public EntityMagmaCube_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
