 ...
 */
public class EntityMagmaCube_1_8_R2 extends EntityMagmaCube {

    private boolean moving;

    public EntityMagmaCube_1_8_R2(World world) {
        super(world);
    }

    public EntityMagmaCube_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
