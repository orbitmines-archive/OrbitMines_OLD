package com.orbitmines.api.spigot.nms.npc.wither.custom;
 ...
 */
public class EntityWither_1_10_R1 extends EntityWither {

    private boolean moving;

    public EntityWither_1_10_R1(World world) {
        super(world);
    }

    public EntityWither_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
