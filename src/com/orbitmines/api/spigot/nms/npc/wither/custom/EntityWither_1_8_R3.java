 ...
 */
public class EntityWither_1_8_R3 extends EntityWither {

    private boolean moving;

    public EntityWither_1_8_R3(World world) {
        super(world);
    }

    public EntityWither_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
