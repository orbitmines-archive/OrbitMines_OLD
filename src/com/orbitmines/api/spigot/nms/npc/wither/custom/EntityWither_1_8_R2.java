 ...
 */
public class EntityWither_1_8_R2 extends EntityWither {

    private boolean moving;

    public EntityWither_1_8_R2(World world) {
        super(world);
    }

    public EntityWither_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
