...
import com.orbitmines.api.spigot.nms.npc.wither.custom.EntityWither_1_12_R1;
...
public class WitherNpc_1_12_R1 implements WitherNpc {
    ...
    public WitherNpc_1_12_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityWither_1_12_R1.class, "CustomWither", Id);
    }
