 ...
 */
public class EntityVex_1_11_R1 extends EntityVex {

    private boolean moving;

    public EntityVex_1_11_R1(World world) {
        super(world);
    }

    public EntityVex_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
