package com.orbitmines.api.spigot.nms.npc.vex.custom;
 ...
 */
public class EntityVex_1_12_R1 extends EntityVex {

    private boolean moving;

    public EntityVex_1_12_R1(World world) {
        super(world);
    }

    public EntityVex_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
