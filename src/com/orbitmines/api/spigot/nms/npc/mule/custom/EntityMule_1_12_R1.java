package com.orbitmines.api.spigot.nms.npc.mule.custom;
 ...
 */
public class EntityMule_1_12_R1 extends EntityHorseMule {

    private boolean moving;

    public EntityMule_1_12_R1(World world) {
        super(world);
    }

    public EntityMule_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
