 ...
 */
public class EntityBlaze_1_8_R2 extends EntityBlaze {

    private boolean moving;

    public EntityBlaze_1_8_R2(World world) {
        super(world);
    }

    public EntityBlaze_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
