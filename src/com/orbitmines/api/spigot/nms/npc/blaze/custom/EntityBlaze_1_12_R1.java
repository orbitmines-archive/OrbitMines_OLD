 ...
 */
public class EntityBlaze_1_12_R1 extends EntityBlaze {

    private boolean moving;

    public EntityBlaze_1_12_R1(World world) {
        super(world);
    }

    public EntityBlaze_1_12_R1(World world, boolean moving, boolean noAttack) {
        super(world);
