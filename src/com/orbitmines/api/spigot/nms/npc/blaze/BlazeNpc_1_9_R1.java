...
import com.orbitmines.api.spigot.nms.npc.blaze.custom.EntityBlaze_1_9_R1;
 ...
 */
public class BlazeNpc_1_9_R1 implements BlazeNpc {

    public BlazeNpc_1_9_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityBlaze_1_9_R1.class, "CustomBlaze", Id);
    }
