...
import com.orbitmines.api.spigot.nms.npc.blaze.custom.EntityBlaze_1_8_R3;
...
public class BlazeNpc_1_8_R3 implements BlazeNpc {
    ...
    public BlazeNpc_1_8_R3() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityBlaze_1_8_R3.class, "CustomBlaze", Id);
    }
