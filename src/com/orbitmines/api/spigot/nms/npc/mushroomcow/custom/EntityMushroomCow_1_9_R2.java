 ...
 */
public class EntityMushroomCow_1_9_R2 extends EntityMushroomCow {

    private boolean moving;

    public EntityMushroomCow_1_9_R2(World world) {
        super(world);
    }

    public EntityMushroomCow_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
