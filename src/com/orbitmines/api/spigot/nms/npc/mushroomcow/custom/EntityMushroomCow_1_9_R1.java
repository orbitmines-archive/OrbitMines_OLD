 ...
 */
public class EntityMushroomCow_1_9_R1 extends EntityMushroomCow {

    private boolean moving;

    public EntityMushroomCow_1_9_R1(World world) {
        super(world);
    }

    public EntityMushroomCow_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
