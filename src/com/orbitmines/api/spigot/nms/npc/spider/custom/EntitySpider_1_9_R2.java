 ...
 */
public class EntitySpider_1_9_R2 extends EntitySpider {

    private boolean moving;

    public EntitySpider_1_9_R2(World world) {
        super(world);
    }

    public EntitySpider_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
