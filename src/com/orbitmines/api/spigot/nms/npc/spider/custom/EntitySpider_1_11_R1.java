 ...
 */
public class EntitySpider_1_11_R1 extends EntitySpider {

    private boolean moving;

    public EntitySpider_1_11_R1(World world) {
        super(world);
    }

    public EntitySpider_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
