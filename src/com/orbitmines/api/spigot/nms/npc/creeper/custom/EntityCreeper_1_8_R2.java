 ...
 */
public class EntityCreeper_1_8_R2 extends EntityCreeper {

    private boolean moving;

    public EntityCreeper_1_8_R2(World world) {
        super(world);
    }

    public EntityCreeper_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
