...
import com.orbitmines.api.spigot.nms.npc.creeper.custom.EntityCreeper_1_8_R2;
...
public class CreeperNpc_1_8_R2 implements CreeperNpc {
    ...
    public CreeperNpc_1_8_R2() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityCreeper_1_8_R2.class, "CustomCreeper", Id);
    }
