 ...
 */
public class EntityCreeper_1_11_R1 extends EntityCreeper {

    private boolean moving;

    public EntityCreeper_1_11_R1(World world) {
        super(world);
    }

    public EntityCreeper_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
