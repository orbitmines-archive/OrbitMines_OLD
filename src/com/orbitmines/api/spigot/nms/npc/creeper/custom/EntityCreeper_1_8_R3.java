 ...
 */
public class EntityCreeper_1_8_R3 extends EntityCreeper {

    private boolean moving;

    public EntityCreeper_1_8_R3(World world) {
        super(world);
    }

    public EntityCreeper_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
