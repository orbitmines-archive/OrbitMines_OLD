package com.orbitmines.api.spigot.nms.npc.ocelot.custom;
 ...
 */
public class EntityOcelot_1_10_R1 extends EntityOcelot {

    private boolean moving;

    public EntityOcelot_1_10_R1(World world) {
        super(world);
    }

    public EntityOcelot_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
