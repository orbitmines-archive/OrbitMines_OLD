...
import com.orbitmines.api.spigot.nms.npc.ocelot.custom.EntityOcelot_1_11_R1;
...
public class OcelotNpc_1_11_R1 implements OcelotNpc {
    ...
    public OcelotNpc_1_11_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityOcelot_1_11_R1.class, "CustomOcelot", Id);
    }
