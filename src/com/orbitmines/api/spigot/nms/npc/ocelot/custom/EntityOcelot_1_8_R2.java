 ...
 */
public class EntityOcelot_1_8_R2 extends EntityOcelot {

    private boolean moving;

    public EntityOcelot_1_8_R2(World world) {
        super(world);
    }

    public EntityOcelot_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
