...
import com.orbitmines.api.spigot.nms.npc.ocelot.custom.EntityOcelot_1_9_R2;
...
public class OcelotNpc_1_9_R2 implements OcelotNpc {
    ...
    public OcelotNpc_1_9_R2() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityOcelot_1_9_R2.class, "CustomOcelot", Id);
    }
