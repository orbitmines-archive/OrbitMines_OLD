 ...
 */
public class EntityOcelot_1_8_R3 extends EntityOcelot {

    private boolean moving;

    public EntityOcelot_1_8_R3(World world) {
        super(world);
    }

    public EntityOcelot_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
