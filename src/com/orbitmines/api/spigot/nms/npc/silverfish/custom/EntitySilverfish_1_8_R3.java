 ...
 */
public class EntitySilverfish_1_8_R3  extends EntitySilverfish {

    private boolean moving;

    public EntitySilverfish_1_8_R3(World world) {
        super(world);
    }

    public EntitySilverfish_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
