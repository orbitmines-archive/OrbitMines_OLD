 ...
 */
public class EntitySilverfish_1_9_R2 extends EntitySilverfish {

    private boolean moving;

    public EntitySilverfish_1_9_R2(World world) {
        super(world);
    }

    public EntitySilverfish_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
