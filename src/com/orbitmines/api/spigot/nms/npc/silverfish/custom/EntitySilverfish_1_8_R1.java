 ...
 */
public class EntitySilverfish_1_8_R1 extends EntitySilverfish {

    private boolean moving;

    public EntitySilverfish_1_8_R1(World world) {
        super(world);
    }

    public EntitySilverfish_1_8_R1(World world, boolean moving, boolean noAttack) {
        super(world);
