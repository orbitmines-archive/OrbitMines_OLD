...
import com.orbitmines.api.spigot.nms.npc.chicken.custom.EntityChicken_1_12_R1;
...
public class ChickenNpc_1_12_R1 implements ChickenNpc {
    ...
    public ChickenNpc_1_12_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityChicken_1_12_R1.class, "CustomChicken", Id);
    }
