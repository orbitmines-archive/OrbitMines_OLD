 ...
 */
public class EntityChicken_1_10_R1 extends EntityChicken {

    private boolean moving;

    public EntityChicken_1_10_R1(World world) {
        super(world);
    }

    public EntityChicken_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
