 ...
 */
public class EntityChicken_1_8_R3 extends EntityChicken {

    private boolean moving;

    public EntityChicken_1_8_R3(World world) {
        super(world);
    }

    public EntityChicken_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
