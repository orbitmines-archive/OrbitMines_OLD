 ...
 */
public class EntityZombie_1_8_R3 extends EntityZombie {

    private boolean moving;

    public EntityZombie_1_8_R3(World world) {
        super(world);
    }

    public EntityZombie_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
