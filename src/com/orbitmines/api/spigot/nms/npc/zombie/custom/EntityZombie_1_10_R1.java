 ...
 */
public class EntityZombie_1_10_R1 extends EntityZombie {

    private boolean moving;

    public EntityZombie_1_10_R1(World world) {
        super(world);
    }

    public EntityZombie_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
