 ...
 */
public class EntityZombie_1_8_R2 extends EntityZombie {

    private boolean moving;

    public EntityZombie_1_8_R2(World world) {
        super(world);
    }

    public EntityZombie_1_8_R2(World world, boolean moving, boolean noAttack) {
        super(world);
