 ...
 */
public class EntityWitch_1_8_R3 extends EntityWitch {

    private boolean moving;

    public EntityWitch_1_8_R3(World world) {
        super(world);
    }

    public EntityWitch_1_8_R3(World world, boolean moving, boolean noAttack) {
        super(world);
