package com.orbitmines.api.spigot.nms.npc.witch.custom;
 ...
 */
public class EntityWitch_1_10_R1 extends EntityWitch {

    private boolean moving;

    public EntityWitch_1_10_R1(World world) {
        super(world);
    }

    public EntityWitch_1_10_R1(World world, boolean moving, boolean noAttack) {
        super(world);
