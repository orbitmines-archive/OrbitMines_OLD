 ...
 */
public class EntityWitch_1_9_R1 extends EntityWitch {

    private boolean moving;

    public EntityWitch_1_9_R1(World world) {
        super(world);
    }

    public EntityWitch_1_9_R1(World world, boolean moving, boolean noAttack) {
        super(world);
