 ...
 */
public class EntityWitch_1_9_R2 extends EntityWitch {

    private boolean moving;

    public EntityWitch_1_9_R2(World world) {
        super(world);
    }

    public EntityWitch_1_9_R2(World world, boolean moving, boolean noAttack) {
        super(world);
