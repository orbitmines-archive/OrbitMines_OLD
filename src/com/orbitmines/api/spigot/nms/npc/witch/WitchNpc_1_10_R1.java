...
import com.orbitmines.api.spigot.nms.npc.witch.custom.EntityWitch_1_10_R1;
...
public class WitchNpc_1_10_R1 implements WitchNpc {
    ...
    public WitchNpc_1_10_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityWitch_1_10_R1.class, "CustomWitch", Id);
    }
