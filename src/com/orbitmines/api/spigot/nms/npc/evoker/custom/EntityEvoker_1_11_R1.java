package com.orbitmines.api.spigot.nms.npc.evoker.custom;
 ...
 */
public class EntityEvoker_1_11_R1 extends EntityEvoker {

    private boolean moving;

    public EntityEvoker_1_11_R1(World world) {
        super(world);
    }

    public EntityEvoker_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
