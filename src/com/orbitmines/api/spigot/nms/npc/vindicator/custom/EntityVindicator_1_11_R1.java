package com.orbitmines.api.spigot.nms.npc.vindicator.custom;
 ...
 */
public class EntityVindicator_1_11_R1 extends EntityVindicator {

    private boolean moving;

    public EntityVindicator_1_11_R1(World world) {
        super(world);
    }

    public EntityVindicator_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
