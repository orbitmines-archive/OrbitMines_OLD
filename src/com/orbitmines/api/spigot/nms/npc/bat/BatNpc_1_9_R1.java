...
import com.orbitmines.api.spigot.nms.npc.bat.custom.EntityBat_1_9_R1;
...
public class BatNpc_1_9_R1 implements BatNpc {
    ...
    public BatNpc_1_9_R1() {
        OrbitMinesApi.getApi().getNms().npc().addCustomEntity(EntityBat_1_9_R1.class, "CustomBat", Id);
    }

    @Override
    public Entity spawn(Location location, String displayName, boolean moving, boolean noAttack) {
        World nmsWorld = ((CraftWorld) location.getWorld()).getHandle();
        EntityBat_1_9_R1 e = new EntityBat_1_9_R1(nmsWorld, moving, noAttack);
