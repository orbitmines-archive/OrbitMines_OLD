 ...
 */
public class EntityBat_1_11_R1 extends EntityBat {

    private boolean moving;

    public EntityBat_1_11_R1(World world) {
        super(world);
    }

    public EntityBat_1_11_R1(World world, boolean moving, boolean noAttack) {
        super(world);
